...
<table border="0" cellpadding="10" cellspacing="0" align="center">
  <tr>
    <td align="left" valign="top" width="60%">
      <h1>💫 Hi, I'm Julian (@0xJust4Sec)</h1>
      <p><strong>Cakrawala University (Information System) Student | BackEnd Developer | Security Enthusiast</strong></p>
      <br>
      🎓 <strong>Education:</strong> Cakrawala University ( Information System )<br>
      💻 <strong>Tech Stack:</strong> Python, JavaScript, Node.js, React, Next.js, C++, PHP<br>
      🛡️ <strong>Cybersecurity:</strong> Active in vulnerability research, OSINT, and CTF challenges<br>
